    ...
    return (
        ...
        <div  className={`flex flex-col items-center justify-content w-[25em] container mx-auto px-4 tr transition-opacity duration-1000 ${transition.transition ? `opacity-100` : `opacity-0`}`}>
            ...
            <div className='flex justify-evenly w-full'>
                <button
                type="button"
                class="text-white bg-gradient-to-r from-green-500 to-green-700 active:ring-1 active:outline-none font-medium rounded-lg text-sm px-4 py-2 text-center bg-blue-600 hover:bg-blue-700 active:ring-green-700 transition-all duration-300 transform hover:scale-105">
                    Ver Proyectos 
                </button>
                <button
